...
INSTRUCTIONS = '\n 1. 通过【选项】或者手动填写 [scale] [scale density] [xdpi] 设置被适配机型的参数' \
               ...
               '\n|  等级   | 分辨率（px）| 屏幕密度（dpi）| 换算（px/dp）| 图标 |' \
               '\n|  ldpi    |   240x320    |         120         |   1dp=0.75px  |   36 * 36   |' \
               '\n|  mdpi  |   320x480    |         160         |   1dp=1px      |   48 * 48   |' \
               '\n|  hdpi   |   480x800    |         240         |   1dp=1.5px    |   72 * 72   |' \
               '\n|  xhdpi  |   720x1280  |         320         |   1dp=2px      |   96 * 96   |' \
               '\n|  xxhdpi |  1080x1920 |         480         |   1dp=3px      |  144 * 144  |' \
               '\n|  xxhdpi |  1440x2560    |     640         |   1dp=4px      |  192 * 192  |' \
